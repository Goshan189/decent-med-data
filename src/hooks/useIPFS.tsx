...
const publicClient = create({
  ...
  protocol: 'https',
  headers: {
    authorization: 'Basic ' + btoa('2FMXLz2VX6K4kJzZ8QjnQzJM0qF:c3f1b7a8e2d4c9f0a1b2c3d4e5f6g7h8')
  }
});
...
export const useIPFS = () => {
  ...
  const uploadToIPFS = async (file: File): Promise<{ hash: string; gateway: string }> => {
    setIsUploading(true);
    setUploadProgress(0);
    ...
    try {
      ...
      const gateway = `https://ipfs.io/ipfs/${hash}`;
