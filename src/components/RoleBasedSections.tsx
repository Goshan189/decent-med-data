    ...
    <section className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <div className="order-2 lg:order-1">
            <img 
              ...
              className="rounded-lg shadow-medical w-full"
            />
          </div>
          <div className="order-1 lg:order-2">
            <Badge variant="outline" className="mb-4 text-secondary-foreground border-secondary">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <Badge variant="outline" className="mb-4 text-accent-foreground border-accent">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button variant="blockchain" size="lg">
          ...
          <div>
            <img 
              ...
              className="rounded-lg shadow-blockchain w-full"
            />
          </div>
        </div>
            ...
            {[
              ...
              <Card key={index} className="p-4 hover:shadow-glow transition-all duration-300">
                <CardContent className="text-center p-0">
                  <h4 className="font-semibold text-primary mb-1">{tech.name}</h4>
